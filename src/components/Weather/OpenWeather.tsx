  ...
  return (
    <div style={containerStyle} className="text-white">
      <div style={headerStyle}>
        <h1 style={containerStyle}>Weather</h1>
        <p style={containerStyle}>Check the weather in different cities</p>
      </div>
      ...
      <div style={buttonContainerStyle}>
        <button style={buttonStyle} onClick={() => setCity('Tel Aviv')}>Tel Aviv</button>
        <button style={buttonStyle} onClick={() => setCity('Jerusalem')}>Jerusalem</button>
        <button style={buttonStyle} onClick={() => setCity('Haifa')}>Haifa</button>
        <button style={buttonStyle} onClick={() => setCity('Dead Sea')}>Dead Sea</button>
      </div>
    </div>
  );
};
